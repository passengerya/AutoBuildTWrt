...
| clashoo | Clashoo代理 | apk (25.12) | 2026.09.16 | arm64 / x86 | 代理工具(与 nikki 冲突勿同时开启) | kenzok8/openwrt-clashoo |
...
| openwrt-daede | eBPF代理 | apk (25.12) | 2026.09.20 | arm64 / x86 | 基于 eBPF 的高性能透明代理(dae/daed) | kenzok8/openwrt-daede |
...
| openwrt-daede | eBPF代理 | ipk (24.10) | 2026.09.20 | arm64 / x86 | 基于 eBPF 的高性能透明代理(dae/daed) | kenzok8/openwrt-daede |
...
| sing-box | Sing-box内核 | ipk (24.10) | v1.14.1 | arm64 / x86 | 通用代理内核 | SagerNet/sing-box |
