...
| bandix | 流量监控 | apk (25.12) | 0.12.10-r1 | arm64 / x86 | Bandix 实时流量监控与统计 | timsaya/luci-app-bandix + timsaya/openwrt-bandix |
...
| openwrt-daede | eBPF代理 | apk (25.12) | 2026.09.25 | arm64 / x86 | 基于 eBPF 的高性能透明代理(dae/daed) | kenzok8/openwrt-daede |
| passwall | PassWall | apk (25.12) | 26.9.16 | arm64 / x86 | 代理工具(自带依赖) | Openwrt-Passwall/openwrt-passwall |
| passwall2 | PassWall2 | apk (25.12) | 26.9.16-1 | arm64 / x86 | 代理工具(自带依赖) | Openwrt-Passwall/openwrt-passwall2 |
...
| bandix | 流量监控 | ipk (24.10) | 0.12.10-r1 | arm64 / x86 | Bandix 实时流量监控与统计 | timsaya/luci-app-bandix + timsaya/openwrt-bandix |
| clashoo | Clashoo代理 | ipk (24.10) | 2026.09.22 | arm64 / x86 | 代理工具(与 nikki 冲突勿同时开启) | kenzok8/openwrt-clashoo |
...
| luci-theme-aurora | 极光主题 | ipk (24.10) | 1.4.0-r20260920 | arm64 / x86 | 极光主题界面(需配套 luci-app-aurora-config 配置中心, 会接管 LuCI 菜单/路由, 谨慎启用) | eamonxg/luci-theme-aurora |
| luci-theme-shadcn | Shadcn主题 | ipk (24.10) | 0.6.0-r20260920 | arm64 / x86 | 现代 Shadcn 风格界面主题(会接管 LuCI 菜单/路由, 24.10 下谨慎启用) | eamonxg/luci-theme-shadcn |
...
| openwrt-daede | eBPF代理 | ipk (24.10) | 2026.09.25 | arm64 / x86 | 基于 eBPF 的高性能透明代理(dae/daed) | kenzok8/openwrt-daede |
...
| sing-box | Sing-box内核 | ipk (24.10) | v1.14.2 | arm64 / x86 | 通用代理内核 | SagerNet/sing-box |
