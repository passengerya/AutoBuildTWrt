...
| openwrt-daede | eBPF代理 | apk (25.12) | 2026.09.25 ⚠️上游停更 | arm64 / x86 | 基于 eBPF 的高性能透明代理(dae/daed) | kenzok8/openwrt-daede |
...
| sing-box | Sing-box内核 | ipk (24.10) | v1.14.2 ⚠️上游停更 | arm64 / x86 | 通用代理内核 | SagerNet/sing-box |
