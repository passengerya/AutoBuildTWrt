...
| clashoo | Clashoo代理 | apk (25.12) | 2026.09.14 | arm64 / x86 | 代理工具(与 nikki 冲突勿同时开启) | kenzok8/openwrt-clashoo |
| easytier | 异地组网 | apk (25.12) | v2.6.4 | arm64 / x86 | EasyTier 点对点组网工具 | EasyTier/luci-app-easytier |
...
| luci-app-aurora-config | 极光配置中心 | apk (25.12) | 1.2.0-r20260808 | arm64 / x86 | Aurora 主题配置中心(提供 /etc/config/aurora, 与主题配套启用) | eamonxg/luci-app-aurora-config |
| luci-app-oaf | 应用过滤 | apk (25.12) | 7.0-r1 | arm64 / x86 | OpenAppFilter 应用过滤(基于 nftables, 程序管控/游戏加速) | destan19/OpenAppFilter |
...
| openwrt-daede | eBPF代理 | apk (25.12) | 2026.09.14 | arm64 / x86 | 基于 eBPF 的高性能透明代理(dae/daed) | kenzok8/openwrt-daede |
| passwall | PassWall | apk (25.12) | 26.9.9 | arm64 / x86 | 代理工具(自带依赖) | Openwrt-Passwall/openwrt-passwall |
| passwall2 | PassWall2 | apk (25.12) | 26.9.12-2 | arm64 / x86 | 代理工具(自带依赖) | Openwrt-Passwall/openwrt-passwall2 |
| quickfile | 文件管理 | apk (25.12) | 1.0.16 | arm64 / x86 | 轻量网页文件管理器(与 luci-app-run 冲突勿同时开启) | sbwml/luci-app-quickfile |
| rtp2httpd | IPTV转发 | apk (25.12) | 3.17.1-r1 | arm64 / x86 | IPTV 流媒体转发服务器 | stackia/rtp2httpd |
| sing-box | Sing-box内核 | apk (25.12) | v1.14.0 | arm64 / x86 | 通用代理内核 | SagerNet/sing-box |
...
| clashoo | Clashoo代理 | ipk (24.10) | 2026.09.11 | arm64 / x86 | 代理工具(与 nikki 冲突勿同时开启) | kenzok8/openwrt-clashoo |
...
| luci-app-aurora-config | 极光配置中心 | ipk (24.10) | 1.2.0-r20260808 | arm64 / x86 | Aurora 主题配置中心(提供 /etc/config/aurora, 与主题配套启用) | eamonxg/luci-app-aurora-config |
...
| openwrt-daede | eBPF代理 | ipk (24.10) | 2026.09.13 | arm64 / x86 | 基于 eBPF 的高性能透明代理(dae/daed) | kenzok8/openwrt-daede |
| passwall | PassWall | ipk (24.10) | 26.9.9-1 | arm64 / x86 | 代理工具(自带依赖) | Openwrt-Passwall/openwrt-passwall |
| passwall2 | PassWall2 | ipk (24.10) | 26.9.12-2 | arm64 / x86 | 代理工具(自带依赖) | Openwrt-Passwall/openwrt-passwall2 |
| quickfile | 文件管理 | ipk (24.10) | 1.0.16 | arm64 / x86 | 轻量网页文件管理器(与 luci-app-run 冲突勿同时开启) | sbwml/luci-app-quickfile |
| rtp2httpd | IPTV转发 | ipk (24.10) | 3.17.1-r1 | arm64 / x86 | IPTV 流媒体转发服务器 | stackia/rtp2httpd |
| sing-box | Sing-box内核 | ipk (24.10) | v1.14.0 | arm64 / x86 | 通用代理内核 | SagerNet/sing-box |
| ssrp-mihomo | SSRP代理 | ipk (24.10) |  | arm64 / x86 | SSR-Plus 代理工具(mihomo 内核) | fw876/helloworld |
