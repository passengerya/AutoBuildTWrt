...
| clashoo | Clashoo代理 | apk (25.12) | 2026.09.14 ⚠️上游停更 | arm64 / x86 | 代理工具(与 nikki 冲突勿同时开启) | kenzok8/openwrt-clashoo |
...
| luci-app-aurora-config | 极光配置中心 | apk (25.12) | 1.2.0-r20260808 ⚠️上游停更 | arm64 / x86 | Aurora 主题配置中心(提供 /etc/config/aurora, 与主题配套启用) | eamonxg/luci-app-aurora-config |
...
| luci-theme-aurora | 极光主题 | apk (25.12) | 1.3.0-r20260830 ⚠️上游停更 | arm64 / x86 | 极光主题界面(需配套 luci-app-aurora-config 配置中心, 会接管 LuCI 菜单/路由, 谨慎启用) | eamonxg/luci-theme-aurora |
...
| openwrt-daede | eBPF代理 | apk (25.12) | 2026.09.14 ⚠️上游停更 | arm64 / x86 | 基于 eBPF 的高性能透明代理(dae/daed) | kenzok8/openwrt-daede |
| passwall | PassWall | apk (25.12) | 26.9.9 ⚠️上游停更 | arm64 / x86 | 代理工具(自带依赖) | Openwrt-Passwall/openwrt-passwall |
| passwall2 | PassWall2 | apk (25.12) | 26.9.12-2 ⚠️上游停更 | arm64 / x86 | 代理工具(自带依赖) | Openwrt-Passwall/openwrt-passwall2 |
...
| sing-box | Sing-box内核 | apk (25.12) | v1.14.0 ⚠️上游停更 | arm64 / x86 | 通用代理内核 | SagerNet/sing-box |
...
| clashoo | Clashoo代理 | ipk (24.10) | 2026.09.11 ⚠️上游停更 | arm64 / x86 | 代理工具(与 nikki 冲突勿同时开启) | kenzok8/openwrt-clashoo |
| dufs | 文件服务器 | ipk (24.10) | 0.46.0-r1 ⚠️上游停更 | arm64 / x86 | 轻量文件服务器(静态托管/上传/WebDAV) | sigoden/dufs |
...
| luci-app-aurora-config | 极光配置中心 | ipk (24.10) | 1.2.0-r20260808 ⚠️上游停更 | arm64 / x86 | Aurora 主题配置中心(提供 /etc/config/aurora, 与主题配套启用) | eamonxg/luci-app-aurora-config |
...
| momo | Momo代理 | ipk (24.10) | v1.2.1 ⚠️上游停更 | arm64 / x86 | 基于 sing-box 的透明代理 | nikkinikki-org/OpenWrt-momo |
...
| openwrt-daede | eBPF代理 | ipk (24.10) | 2026.09.13 ⚠️上游停更 | arm64 / x86 | 基于 eBPF 的高性能透明代理(dae/daed) | kenzok8/openwrt-daede |
...
| sing-box | Sing-box内核 | ipk (24.10) | v1.14.0 ⚠️上游停更 | arm64 / x86 | 通用代理内核 | SagerNet/sing-box |
