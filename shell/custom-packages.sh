...
# ───────────────────── 代理工具 ─────────────────────
# 自动生成: clashoo | Clashoo代理 | 代理工具(与 nikki 冲突勿同时开启) | 2026.09.11 上游停更(保留旧版) | 取消下一行注释即启用
...
# 自动生成: openwrt-daede | eBPF代理 | 基于 eBPF 的高性能透明代理(dae/daed) | 2026.09.13 上游停更(保留旧版) | 取消下一行注释即启用
